...
public class Lambda3 {
	...
	public static void main(String[] args) {
        String[] str = {"Ksheera", "Chaya","Priya"};
		...
		Predicate<String[]> predicate = (string) -> Arrays.toString(string).contains("Ksheera");     //The Predicate interface has only one single method test().
		...
		System.out.println(function.apply(str));                                                  //It can accept an object of any data type and returns a result of any data.
